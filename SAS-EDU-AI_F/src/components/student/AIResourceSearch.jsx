...
const AIResourceSearch = () => {
  ...
  const ResourceCard = ({ resource, index }) => (
    <div key={index} className="bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow border border-gray-200 dark:border-gray-700 overflow-hidden">
      <div className="p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-3 mb-2 sm:mb-3">
          <div className="flex-1 min-w-0">
            <h4 className="text-base sm:text-lg font-semibold text-blue-600 truncate">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 active:bg-blue-800 transition-colors text-sm"
        >
  ...
  const ChunkCard = ({ source, index }) => (
    <div key={index} className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
      <div className="p-4 sm:p-5">
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-md p-3 sm:p-4 mb-3 border-l-4 border-blue-500">
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-xs sm:text-sm line-clamp-3 sm:line-clamp-none">
    ...
    if (isSearching) {
      return (
        <div className="text-center py-8 sm:py-12">
          ...
          <p className="mt-3 sm:mt-4 text-gray-600 dark:text-gray-400 text-sm sm:text-base">Searching materials...</p>
        </div>
      );
    }
        ...
        return (
          <div>
            ...
            {resources.length > 0 ? (
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8 sm:p-12 text-center text-gray-500 dark:text-gray-400 text-sm sm:text-base">
          ...
          <div className="space-y-3 sm:space-y-4">
            {resource && (
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
                  <div className="flex-1 min-w-0">
                    <h3 className="text-base sm:text-lg font-semibold text-blue-900 dark:text-blue-300 truncate">
                      {resource.title}
                    </h3>
                    <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-400 truncate mt-0.5">{resource.file_name}</p>
                  </div>
                  <span className={`self-start px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs font-medium flex-shrink-0 ${getTypeColor(resource.resource_type)}`}>
                    {resource.resource_type}
                  </span>
            ...
            {summary && (
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
                <h4 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white mb-2 sm:mb-3">Summary</h4>
                <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed whitespace-pre-line">{summary}</p>
              </div>
            )}
          </div>
        );
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
              <div className="flex items-center gap-2 mb-2 sm:mb-3">
                ...
                <h4 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white">AI Answer</h4>
              ...
              <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed whitespace-pre-line">{answer}</p>
            </div>
      ...
      default:
        return (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8 sm:p-12 text-center">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-1 sm:mb-2">No results found</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base">Try rephrasing your question</p>
          </div>
        );
    }
  };
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base">Search all materials using natural language</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 sm:p-6 mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          <div className="flex-1">
            <input
              ...
              className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-lg dark:bg-gray-700 dark:text-white"
        ...
        <div className="mt-3 sm:mt-4 flex items-start gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
      ...
      {!hasSearched && (
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 sm:p-6">
          <h3 className="font-semibold text-blue-900 dark:text-blue-300 mb-2 flex items-center gap-2 text-sm sm:text-base">
            <svg className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
            </svg>
            How AI Search Works
          </h3>
          <ul className="text-blue-800 dark:text-blue-300 space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
